<template>
  ...
  >
    ...
    <div
      class="hint-arrow"
      ng-repeat="direction in ['left','right','top','bottom']"
      ng-class="[direction, aic.vars.noob ? 'noob-emphasis' : null]"
      ng-style="{'background-image': 'url(' + aic.lang.images.highlightArrow[direction] + ')'}"
    ></div>
    <div
      class="options"
